...
data class BarangSkema(val id:Long?, val namaBarang: String, val hargaBeli: Int, val foto: String, val jumlah: Int, val total: Int, val uuid: String, val maxQuantity: Int) {
    companion object {
